...
export default function LoadingView({
  ...
  useEffect(() => {
    if (!shouldShow || !pathRef.current) return;
    ...
    >
      ...
      <style jsx global>{`
        .draw-and-erase {
          ...
          animation: drawErase 3.5s ease-in-out infinite;
        }
