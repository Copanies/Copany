          ...
          return (
            ...
            >
              <div className="flex gap-3 test-base h-11 items-center">
                ...
                <div className="sticky right-0 h-11 flex items-center justify-start gap-0 bg-white dark:bg-gray-950 group group-hover:bg-gray-50 dark:group-hover:bg-gray-900 border-l border-gray-200 dark:border-gray-700">
                  <div
                    data-role="actions"
