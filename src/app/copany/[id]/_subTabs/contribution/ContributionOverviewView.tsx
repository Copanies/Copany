...
import ContributionChart from "@/app/copany/[id]/_subTabs/contribution/_components/ContributionChart";
import ContributionPieChart from "@/app/copany/[id]/_subTabs/contribution/_components/ContributionPieChart";
...
export default function ContributionOverviewView({
  ...
  return (
    <div className="flex flex-col min-w-0 gap-6 mb-8 ml-0 mt-0 md:ml-5 md:mt-2">
