...
公司通过薪资体系，将人们组织起来，共同完成那些个人难以独立完成的伟大事业，同时为成员提供了相对稳定的收入。然而，这种看似成熟的合作方式，在带来效率与秩序的同时，也存在以下几个长期困扰我们的问题：

1. **加入或离开团队要付出高昂成本**

   更换团队、追求新的方向，是一件成本高额的事情。需要经历繁琐的面试、放弃奖金，还得冒着下一份工作可能更糟的风险。

2. **日常工作有无意义感**

   由于我们是在为别人工作，而不是为我们的事业。许多工作任务的存在，并非源于真正的产品需求或个人信念，而是出于管理层的决策、流程或考核要求。
...
4. **公司自身的高成本与管理困境**
   ...
   对公司而言，招聘合适的人需要耗费大量时间筛选与面试。
   员工入职后，由于上述问题，公司还需投入更多精力去“管理”与“激励”员工，而这些方式往往并不理想。

## 介绍

Copany 旨在创造一种自由、透明、成果共享的协作方式。
...
2.  **项目收益按贡献积分分配**
    ...
    你参与的项目，有一部分始终属于你。即使你离开项目，也依然能分享其未来收益。
...
4.  **未来将支持更多形式的贡献**
    ...
    除了完成事项，Copany 计划支持资金或物资投入的贡献方式。
...
在传统公司中，薪资体系的本质是“工作时间 × 经验匹配的时薪”。在 Copany 中，我们既不限制你的工作时间，也不通过面试来评估经验，因此无法采用这种方式衡量贡献。

于是，我们选择以时间和经验的产物，即「完成的事项」作为衡量标准。而一个事项所需的时间与其复杂度高度相关，因此通过“事项复杂度”即可相对公平地反映贡献。

> 在 Copany 中，只有达到既定质量标准的事项才会被视为有效交付并计入贡献积分。而能否达标取决于执行者的经验与能力，因此经验因素已在体系中被间接体现。这使得 Copany 能够通过“事项复杂度”这一单一维度，较为公平地衡量不同贡献者的投入。
